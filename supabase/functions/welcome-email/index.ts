...
<body style="margin:0;padding:0;background:#f7f8fa;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f7f8fa;padding:40px 0;">
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
        ...
        <tr><td style="background:#ffffff;padding:40px;">
          ...
          <p style="margin:0 0 24px;color:#6b7280;font-size:15px;line-height:1.6;">You're now part of the fastest-growing marketplace for car parts, tools, and vehicles. Buy, sell, and bid with verified enthusiasts across the country.</p>
          ...
          <!-- Referral Block -->
          <table width="100%" cellpadding="0" cellspacing="0" style="background:linear-gradient(135deg,#1a1d24 0%,#2d3142 100%);border-radius:14px;overflow:hidden;">
            <tr><td style="padding:28px 32px;">
              ...
              <a href="${referralLink}" style="display:inline-block;background:#e89400;color:#000;font-weight:800;font-size:14px;padding:12px 28px;border-radius:8px;text-decoration:none;letter-spacing:0.5px;">Copy My Referral Link</a>
            </td></tr>
          </table>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:32px;">
            <tr>
              <td style="padding:16px;background:#f7f8fa;border-radius:10px;text-align:center;width:30%;">
                ...
                <div style="font-size:13px;font-weight:700;color:#1a1d24;">Parts &amp; Tools</div>
        ...
        <tr><td style="background:#f7f8fa;border-radius:0 0 16px 16px;padding:24px 40px;text-align:center;">
          <p style="margin:0;color:#9ca3af;font-size:12px;">You received this because you signed up for PartShift.<br>© 2026 PartShift. All rights reserved.</p>
        </td></tr>
    ...
    const res = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        from: "PartShift <welcome@partshift.com>",
        to: email,
        subject: `Welcome to PartShift, ${name}! Here's your referral link 🎁`,
        html,
      }),
    });
