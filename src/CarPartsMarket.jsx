...
/* ============== DATA ============== */
const initialParts = [
  { id: 1, type: "part", title: "Brembo GT Brake Kit", category: "Brakes", price: 1249, condition: "New", sellerId: "u2", city: "Los Angeles", state: "CA", zip: "90001", image: "🔴", tag: "HOT", desc: "Front big brake kit, fits BMW E46/E90." },
  { id: 2, type: "part", title: 'Snap-on 1/2" Impact Wrench', category: "Tools", price: 389, condition: "Used – Excellent", sellerId: "u3", city: "Chicago", state: "IL", zip: "60601", image: "🔧", tag: "VERIFIED", desc: "MG725. Lightly used. Includes carry case." },
  { id: 3, type: "part", title: "HKS Supercharger Kit – EJ25", category: "Engine", price: 3450, condition: "New", sellerId: "u4", city: "Houston", state: "TX", zip: "77001", image: "⚡", tag: "NEW", desc: "Brand new in box. Bolt-on for WRX/STI." },
  { id: 4, type: "part", title: "KW Variant 3 Coilover Kit", category: "Suspension", price: 2199, condition: "New", sellerId: "u5", city: "Miami", state: "FL", zip: "33101", image: "🛞", tag: "", desc: "Adjustable damping. Sealed boxes." },
  { id: 5, type: "part", title: "OBD2 Pro Scan Tool", category: "Tools", price: 149, condition: "New", sellerId: "u6", city: "Atlanta", state: "GA", zip: "30301", image: "📡", tag: "HOT", desc: "Bluetooth scanner. iOS / Android." },
  { id: 6, type: "part", title: "Mishimoto Intercooler STI", category: "Cooling", price: 599, condition: "Used – Good", sellerId: "u4", city: "Portland", state: "OR", zip: "97201", image: "❄️", tag: "", desc: "Top-mount upgrade. Used one season." },
  { id: 7, type: "part", title: "Akrapovic Titanium Exhaust", category: "Exhaust", price: 1875, condition: "Used – Good", sellerId: "u3", city: "Denver", state: "CO", zip: "80201", image: "🔊", tag: "", desc: "M3 F80 fitment. Heat discoloration on tips." },
  { id: 8, type: "part", title: "Milwaukee M18 Tool Set (12pc)", category: "Tools", price: 699, condition: "New", sellerId: "u2", city: "Phoenix", state: "AZ", zip: "85001", image: "🔩", tag: "VERIFIED", desc: "Fuel-series 12-piece kit." },
  { id: 9, type: "part", title: "K&N Cold Air Intake – F150", category: "Engine", price: 329, condition: "New", sellerId: "u5", city: "Dallas", state: "TX", zip: "75201", image: "💨", tag: "", desc: "Performance intake for 5.0L V8." },
  { id: 10, type: "part", title: "OEM Subaru STI Wheels (set of 4)", category: "Wheels", price: 850, condition: "Used – Excellent", sellerId: "u2", city: "Seattle", state: "WA", zip: "98101", image: "⭕", tag: "", desc: "18x8.5 BBS forged. Minor curb rash." },
  { id: 11, type: "part", title: "Harbor Freight Floor Jack 3-Ton", category: "Tools", price: 89, condition: "Used – Fair", sellerId: "u6", city: "San Francisco", state: "CA", zip: "94101", image: "🔨", tag: "", desc: "Works fine, some scuffs." },
  { id: 12, type: "part", title: "Borla S-Type Mufflers (pair)", category: "Exhaust", price: 425, condition: "Used – Excellent", sellerId: "u4", city: "Nashville", state: "TN", zip: "37201", image: "🔊", tag: "VERIFIED", desc: "Pulled from Mustang GT. <5k mi." },
];

const initialCars = [
  { id: 101, type: "car", make: "Subaru", model: "WRX STI", year: 2018, trim: "Limited", price: 31500, mileage: 42300, transmission: "6-Speed Manual", drivetrain: "AWD", fuel: "Gasoline", color: "World Rally Blue", sellerId: "u2", city: "Seattle", state: "WA", zip: "98101", image: "🏎️", tag: "VERIFIED", vin: "JF1VA2*****12345", desc: "Adult-owned, never tracked. Full records." },
  { id: 102, type: "car", make: "Toyota", model: "Tacoma TRD Off-Road", year: 2021, trim: "Double Cab", price: 38900, mileage: 28500, transmission: "6-Speed Auto", drivetrain: "4WD", fuel: "Gasoline", color: "Cement Gray", sellerId: "u3", city: "Denver", state: "CO", zip: "80201", image: "🛻", tag: "HOT", vin: "3TMCZ5A*****8821", desc: "One owner. Lift, all-terrains." },
  { id: 103, type: "car", make: "BMW", model: "M3 Competition", year: 2022, trim: "xDrive", price: 78500, mileage: 12800, transmission: "8-Speed Auto", drivetrain: "AWD", fuel: "Gasoline", color: "Isle of Man Green", sellerId: "u4", city: "Miami", state: "FL", zip: "33101", image: "🚗", tag: "VERIFIED", vin: "WBS8M9*****0042", desc: "Carbon roof, executive package." },
  { id: 104, type: "car", make: "Ford", model: "Mustang GT", year: 2019, trim: "Premium", price: 28750, mileage: 51000, transmission: "6-Speed Manual", drivetrain: "RWD", fuel: "Gasoline", color: "Race Red", sellerId: "u5", city: "Houston", state: "TX", zip: "77001", image: "🚙", tag: "", vin: "1FA6P8*****3344", desc: "PP1, MagneRide. Bone stock." },
  { id: 105, type: "car", make: "Honda", model: "Civic Type R", year: 2020, trim: "Touring", price: 36400, mileage: 35200, transmission: "6-Speed Manual", drivetrain: "FWD", fuel: "Gasoline", color: "Championship White", sellerId: "u6", city: "Los Angeles", state: "CA", zip: "90001", image: "🚘", tag: "HOT", vin: "SHHFK8*****7711", desc: "FK8. No track use." },
  { id: 106, type: "car", make: "Tesla", model: "Model 3 Performance", year: 2023, trim: "AWD", price: 41200, mileage: 18900, transmission: "Single-Speed", drivetrain: "AWD", fuel: "Electric", color: "Pearl White", sellerId: "u2", city: "San Francisco", state: "CA", zip: "94101", image: "⚡", tag: "NEW", vin: "5YJ3E1*****9988", desc: "FSD transferable. Free supercharging." },
  { id: 107, type: "car", make: "Jeep", model: "Wrangler Rubicon", year: 2017, trim: "Unlimited", price: 32600, mileage: 67800, transmission: "5-Speed Auto", drivetrain: "4WD", fuel: "Gasoline", color: "Firecracker Red", sellerId: "u3", city: "Phoenix", state: "AZ", zip: "85001", image: "🚐", tag: "", vin: "1C4HJW*****5566", desc: "Lifted, 35s, locked." },
  { id: 108, type: "car", make: "Porsche", model: "911 Carrera S", year: 2016, trim: "Coupe", price: 72000, mileage: 38400, transmission: "7-Speed PDK", drivetrain: "RWD", fuel: "Gasoline", color: "GT Silver", sellerId: "u4", city: "Atlanta", state: "GA", zip: "30301", image: "🏁", tag: "VERIFIED", vin: "WP0AB2*****1100", desc: "991.1 Carrera S. Sport Chrono." },
];

// === AUCTIONS === (each starts with a duration in seconds from "now")
const initialAuctions = [
  { id: 201, type: "auction", itemType: "car", title: "1995 Toyota Supra Turbo", make: "Toyota", model: "Supra Turbo", year: 1995, mileage: 89200, image: "🏎️", category: "JDM Classic", currentBid: 84500, startBid: 60000, reserve: 90000, bidCount: 27, sellerId: "u4", city: "Houston", state: "TX", zip: "77001", endsInSec: 86400 + 7200, desc: "MK4 Supra Turbo, 6-speed manual. Documented service. Adult-owned. Reserve not yet met.", tag: "HOT" },
  { id: 202, type: "auction", itemType: "car", title: "1969 Chevrolet Camaro SS", make: "Chevrolet", model: "Camaro SS", year: 1969, mileage: 78400, image: "🏁", category: "American Muscle", currentBid: 51200, startBid: 35000, reserve: 0, bidCount: 41, sellerId: "u3", city: "Chicago", state: "IL", zip: "60601", endsInSec: 3600 * 5, desc: "Numbers-matching 396ci big-block. Restored 2018. No reserve.", tag: "NEW" },
  { id: 203, type: "auction", itemType: "part", title: "Vintage Snap-on Tool Cabinet (1972)", category: "Tools", image: "🧰", currentBid: 2150, startBid: 800, reserve: 2500, bidCount: 18, sellerId: "u3", city: "Chicago", state: "IL", zip: "60601", endsInSec: 3600 * 28, desc: "Original red Snap-on roll cabinet, 11 drawers, all original handles. Some patina.", tag: "VERIFIED" },
  { id: 204, type: "auction", itemType: "part", title: "Garrett GTX3582R Gen II Turbo", category: "Engine", image: "💨", currentBid: 1825, startBid: 1200, reserve: 0, bidCount: 12, sellerId: "u4", city: "Houston", state: "TX", zip: "77001", endsInSec: 3600 * 12, desc: "Brand new in box. Dual ball bearing. T3 inlet. No reserve.", tag: "" },
  { id: 205, type: "auction", itemType: "part", title: "Recaro Pole Position ABE Seats (Pair)", category: "Interior", image: "💺", currentBid: 1420, startBid: 800, reserve: 1800, bidCount: 9, sellerId: "u2", city: "Los Angeles", state: "CA", zip: "90001", endsInSec: 3600 * 60, desc: "Used pair, FIA expired but cosmetically clean. Slider rails included.", tag: "" },
  { id: 206, type: "auction", itemType: "car", title: "2008 Mitsubishi Evolution X MR", make: "Mitsubishi", model: "Lancer Evolution X MR", year: 2008, mileage: 64200, image: "🚘", category: "JDM", currentBid: 27800, startBid: 18000, reserve: 30000, bidCount: 22, sellerId: "u5", city: "Miami", state: "FL", zip: "33101", endsInSec: 3600 * 40, desc: "Phantom Black, SST transmission, fully unmodified. Two owners.", tag: "HOT" },
];
...
const initialVideos = [
  { id: 301, title: "How to Replace Brake Pads & Rotors", category: "Brakes", level: "Beginner", duration: "12:48", views: 142000, likes: 3800, channel: "GarageProTools", channelId: "u3", thumb: "🔴", desc: "Complete walkthrough: tools needed, torque specs, bedding-in procedure. Works for most cars.", tags: ["brakes", "diy", "maintenance"] },
  { id: 302, title: "Coilover Install on a 2018 WRX STI", category: "Suspension", level: "Intermediate", duration: "23:15", views: 89000, likes: 2400, channel: "ChassisTech", channelId: "u5", thumb: "🛞", desc: "Step-by-step KW V3 coilover installation. Includes corner-balancing tips.", tags: ["suspension", "subaru", "install"] },
  { id: 303, title: "Diagnosing Misfires with an OBD2 Scanner", category: "Diagnostics", level: "Beginner", duration: "8:22", views: 256000, likes: 6100, channel: "GarageProTools", channelId: "u3", thumb: "📡", desc: "Read codes, identify the cylinder, and narrow down causes (coil, plug, injector).", tags: ["obd2", "diagnostics", "misfire"] },
  { id: 304, title: "Turbo Install: Garrett GTX3582R", category: "Engine", level: "Advanced", duration: "47:30", views: 64000, likes: 1900, channel: "TurboNation", channelId: "u4", thumb: "💨", desc: "Full bolt-on turbo install. Oil/coolant lines, downpipe routing, tuning prep.", tags: ["turbo", "engine", "advanced"] },
  { id: 305, title: "Cat-Back Exhaust Install in 30 Minutes", category: "Exhaust", level: "Beginner", duration: "11:05", views: 178000, likes: 4500, channel: "SpeedKraft", channelId: "u2", thumb: "🔊", desc: "Easy weekend mod. Just hand tools required. Sound clip included.", tags: ["exhaust", "diy", "easy"] },
  { id: 306, title: "Cold Air Intake: Worth It or Marketing Hype?", category: "Engine", level: "Beginner", duration: "9:40", views: 312000, likes: 8200, channel: "SpeedKraft", channelId: "u2", thumb: "💨", desc: "Real dyno numbers, sound test, and honest verdict on intake mods.", tags: ["intake", "review", "dyno"] },
  { id: 307, title: "Changing Your Own Oil — Full Walkthrough", category: "Maintenance", level: "Beginner", duration: "7:18", views: 524000, likes: 12000, channel: "GarageProTools", channelId: "u3", thumb: "🛢️", desc: "Save $50 every oil change. Tools, oil selection, and disposal tips.", tags: ["maintenance", "oil", "basics"] },
  { id: 308, title: "EV Battery Replacement: What You Need to Know", category: "Maintenance", level: "Advanced", duration: "18:55", views: 41000, likes: 1100, channel: "EVNation", channelId: "u6", thumb: "⚡", desc: "Cost, options, refurbished vs new, safety considerations.", tags: ["ev", "battery", "tesla"] },
  { id: 309, title: "Flushing Brake Fluid (DOT3/4) the Right Way", category: "Brakes", level: "Intermediate", duration: "14:22", views: 98000, likes: 2700, channel: "GarageProTools", channelId: "u3", thumb: "🔴", desc: "Two-person bleed and one-person vacuum methods. Avoid spongy pedal.", tags: ["brakes", "fluid", "maintenance"] },
  { id: 310, title: "Wheel Bearing Replacement (Front Hub)", category: "Suspension", level: "Intermediate", duration: "26:40", views: 73000, likes: 1800, channel: "ChassisTech", channelId: "u5", thumb: "⭕", desc: "Diagnose the bad bearing, press-out tools, torque specs.", tags: ["bearing", "suspension", "diy"] },
  { id: 311, title: "Reading a Wiring Diagram: Beginner's Guide", category: "Diagnostics", level: "Beginner", duration: "15:10", views: 187000, likes: 4900, channel: "GarageProTools", channelId: "u3", thumb: "📋", desc: "Decode any factory service manual diagram. Symbols, colors, signal flow.", tags: ["wiring", "electrical", "basics"] },
  { id: 312, title: "Restoration: Bringing a '69 Camaro Back to Life", category: "Restoration", level: "Advanced", duration: "1:02:34", views: 218000, likes: 7400, channel: "SpeedKraft", channelId: "u2", thumb: "🏁", desc: "Multi-month restoration documentary. Bodywork, paint, drivetrain rebuild.", tags: ["classic", "restoration", "vintage"] },
];
      ...
      <header style={styles.header}>
        <div style={styles.headerInner}>
          ...
          <nav style={styles.nav}>
            {[["browse", "Parts"], ["cars", "Cars"], ["auctions", "🔨 Auctions"], ["videos", "🎬 Videos"], ["sell", "Sell"]].map(([v, l]) => (
          ...
          <>
            <section style={styles.hero}>
              <div style={styles.heroContent}>
                <p style={styles.heroEyebrow}>The Enthusiast's Marketplace</p>
                <h1 style={styles.heroTitle}>Buy. Bid.<br />Build the Machine.</h1>
                <p style={styles.heroSub}>New & used parts, tools, and complete vehicles — fixed price or live auction.</p>
                ...
                <div style={styles.heroCtas}>
                  <button style={styles.heroCta} onClick={() => setView("auctions")}>🔨 View Live Auctions</button>
                  <button style={styles.heroCtaGhost} onClick={() => setView("sell")}>Sell Something</button>
                </div>
              </div>
              <div style={styles.heroVisual}><div style={styles.heroGear}>⚙</div></div>
            </section>
        ...
        {view === "cars" && (
          <>
            <section style={styles.carsHero}>
              <p style={styles.heroEyebrow}>Used Vehicles</p>
              <h1 style={styles.carsTitle}>Find Your Next Drive.</h1>
              <p style={styles.heroSub}>Browse by region, by state, or set a max distance from your zip.</p>
            </section>
        ...
        {view === "auctions" && (
          <>
            <section style={styles.auctionHero}>
              ...
              <h1 style={styles.carsTitle}>Bid. Win. Drive.</h1>
              <p style={styles.heroSub}>Cars, parts, and tools sold to the highest bidder. Real-time bidding, transparent reserves.</p>
            </section>
        ...
        {view === "videos" && !activeVideo && (
          <>
            <section style={styles.videoHero}>
              <div style={styles.auctionBadge}>🎬 LEARN & REPAIR</div>
              <h1 style={styles.carsTitle}>How-To Videos & Repair Guides.</h1>
              <p style={styles.heroSub}>Step-by-step tutorials from verified mechanics and shops. Save money. Wrench smarter.</p>
            </section>
  ...
  return (
    <div style={styles.card} onClick={onClick}>
      <div style={styles.cardImg}>
        {item.image}
        <button style={styles.saveHeart} onClick={onSave}>{saved ? "❤️" : "🤍"}</button>
        <span style={{ ...styles.condBadge, background: isNewItem ? C.green : "#888" }}>{isNewItem ? "NEW" : "USED"}</span>
      </div>
  ...
  return (
    <div style={styles.carCard} onClick={onClick}>
      <div style={styles.carImg}>
        ...
        <button style={{ ...styles.saveHeart, top: 14, right: 14, left: "auto" }} onClick={onSave}>{saved ? "❤️" : "🤍"}</button>
      </div>
  ...
  return (
    <div style={{ ...styles.carCard, borderColor: ending ? C.red : C.border }} onClick={onClick}>
      <div style={styles.auctionImg}>
        {auction.image}
        <button style={{ ...styles.saveHeart, top: 14, right: 14, left: "auto" }} onClick={onSave}>{saved ? "❤️" : "🤍"}</button>
        <span style={styles.auctionTypeBadge}>🔨 {auction.itemType === "car" ? "CAR" : "PART"}</span>
  ...
  return (
    <div style={styles.detailWrap}>
      ...
      <div style={styles.detailCard}>
        <div style={isCar || isAuction ? styles.carDetailImg : styles.detailImg}>{item.image}</div>
  ...
  return (
    <div style={styles.videoCard} onClick={onClick}>
      <div style={styles.videoThumb}>
        <span style={styles.videoThumbIcon}>{video.thumb}</span>
        <span style={styles.playOverlay}>▶</span>
        <span style={styles.videoDuration}>{video.duration}</span>
        <span style={{ ...styles.videoLevel, background: levelColor }}>{video.level}</span>
      </div>
        ...
        <div style={styles.videoMain}>
          <div style={styles.videoPlayer}>
            <div style={styles.videoPlayerInner}>
              <span style={styles.videoPlayerIcon}>{video.thumb}</span>
...
/* ============== STYLES ============== */
const styles = {
  root: { fontFamily: "'DM Mono', 'Courier New', monospace", background: C.bg, color: C.text, minHeight: "100vh", width: "100%", display: "flex", flexDirection: "column", margin: 0 },
  ...
  heroVisual: { width: 220, height: 220, display: "flex", alignItems: "center", justifyContent: "center" },
  ...
  auctionTypeBadge: { position: "absolute", top: 14, left: 14, background: C.purple, color: "#fff", fontSize: 10, fontWeight: 800, letterSpacing: 1.5, padding: "3px 8px", borderRadius: 4 },
